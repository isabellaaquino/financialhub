...
function useServerHandoffComplete() {
  let [complete, setComplete] = (0, import_react5.useState)(env.isHandoffComplete);
  ...
  (0, import_react5.useEffect)(() => env.handoff(), []);
  return complete;
}

// src/hooks/use-id.ts
var _a;
var useId2 = (_a = React2.useId) != null ? _a : function useId3() {
  let ready = useServerHandoffComplete();
  let [id, setId] = React2.useState(ready ? () => env.nextId() : null);
  useIsoMorphicEffect(() => {
    if (id === null)
      setId(env.nextId());
  }, [id]);
...
function useOutsideClick(containers, cb, enabled = true) {
  let enabledRef = (0, import_react7.useRef)(false);
  (0, import_react7.useEffect)(false ? () => {
  ...
  let initialClickTarget = (0, import_react7.useRef)(null);
...
function useResolveButtonType(props, ref) {
  let [type, setType] = (0, import_react8.useState)(() => resolveType(props));
  useIsoMorphicEffect(() => {
...
function useSyncRefs(...refs) {
  let cache = (0, import_react9.useRef)(refs);
...
function useTreeWalker({
  ...
  let acceptRef = (0, import_react10.useRef)(accept);
  let walkRef = (0, import_react10.useRef)(walk);
...
function _render(props, slot = {}, tag, name) {
  ...
  if (Component === import_react11.Fragment) {
    if (Object.keys(compact(rest)).length > 0) {
      if (!(0, import_react11.isValidElement)(resolvedChildren) || Array.isArray(resolvedChildren) && resolvedChildren.length > 1) {
        throw new Error([
      ...
      return (0, import_react11.cloneElement)(resolvedChildren, Object.assign({}, mergeProps(resolvedChildren.props, compact(omit(rest, ["ref"]))), dataAttributes, refRelatedProps, mergeRefs(resolvedChildren.ref, refRelatedProps.ref), classNameProps));
    }
  }
  return (0, import_react11.createElement)(Component, Object.assign({}, omit(rest, ["ref"]), Component !== import_react11.Fragment && refRelatedProps, Component !== import_react11.Fragment && dataAttributes), resolvedChildren);
}
...
function forwardRefWithAs(component) {
  var _a3;
  return Object.assign((0, import_react11.forwardRef)(component), {
...
function useControllable(controlledValue, onChange, defaultValue) {
  let [internalValue, setInternalValue] = (0, import_react13.useState)(defaultValue);
  let isControlled = controlledValue !== void 0;
  let wasControlled = (0, import_react13.useRef)(isControlled);
  let didWarnOnUncontrolledToControlled = (0, import_react13.useRef)(false);
  let didWarnOnControlledToUncontrolled = (0, import_react13.useRef)(false);
...
function useWatch(cb, dependencies) {
  let track = (0, import_react14.useRef)([]);
...
function useTrackedPointer() {
  let lastPos = (0, import_react15.useRef)([-1, -1]);
  return {
    wasMoved(evt) {
      if (false) {
        return true;
...
var reducers = {
  ...
  [2 /* GoToOption */](state, action) {
    ...
    if (state.dataRef.current.disabled)
      return state;
    if (state.dataRef.current.optionsRef.current && !state.dataRef.current.optionsPropsRef.current.static && state.comboboxState === 1 /* Closed */) {
      return state;
    }
  ...
  [3 /* RegisterOption */]: (state, action) => {
    ...
    if (state.dataRef.current.__demoMode && state.dataRef.current.value === void 0) {
...
var ComboboxActionsContext = (0, import_react16.createContext)(null);
ComboboxActionsContext.displayName = "ComboboxActionsContext";
function useActions(component) {
  let context = (0, import_react16.useContext)(ComboboxActionsContext);
  if (context === null) {
...
var ComboboxDataContext = (0, import_react16.createContext)(null);
ComboboxDataContext.displayName = "ComboboxDataContext";
function useData(component) {
  let context = (0, import_react16.useContext)(ComboboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Combobox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_COMBOBOX_TAG = import_react16.Fragment;
function ComboboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react16.useReducer)(stateReducer, {
    dataRef: (0, import_react16.createRef)(),
  ...
  let defaultToFirstOption = (0, import_react16.useRef)(false);
  let optionsPropsRef = (0, import_react16.useRef)({ static: false, hold: false });
  let labelRef = (0, import_react16.useRef)(null);
  let inputRef = (0, import_react16.useRef)(null);
  let buttonRef = (0, import_react16.useRef)(null);
  let optionsRef = (0, import_react16.useRef)(null);
  let compare = useEvent(typeof by === "string" ? (a, z) => {
    let property = by;
    return (a == null ? void 0 : a[property]) === (z == null ? void 0 : z[property]);
  } : by);
  let isSelected = (0, import_react16.useCallback)((compareValue) => match(data.mode, {
    [1 /* Multi */]: () => value.some((option) => compare(option, compareValue)),
    [0 /* Single */]: () => compare(value, compareValue)
  }), [value]);
  let data = (0, import_react16.useMemo)(() => ({
    ...state,
    optionsPropsRef,
    labelRef,
    inputRef,
  ...
  let registerOption = useEvent((id, dataRef) => {
    ...
    return () => dispatch({ type: 4 /* UnregisterOption */, id });
  });
  ...
  let actions = (0, import_react16.useMemo)(() => ({
    onChange,
    registerOption,
    registerLabel,
    goToOption,
  ...
  let form = (0, import_react16.useRef)(null);
  ...
  return /* @__PURE__ */ React4.createElement(ComboboxActionsContext.Provider, {
    value: actions
  }, /* @__PURE__ */ React4.createElement(ComboboxDataContext.Provider, {
    value: data
  }, /* @__PURE__ */ React4.createElement(OpenClosedProvider, {
    value: match(data.comboboxState, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })
  }, name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2], idx) => /* @__PURE__ */ React4.createElement(Hidden, {
    features: 4 /* Hidden */,
    ref: idx === 0 ? (element) => {
      var _a3;
...
var Input = forwardRefWithAs(function Input2(props, ref) {
  ...
  let isTyping = (0, import_react16.useRef)(false);
  let d = useDisposables();
  ...
  let isComposing = (0, import_react16.useRef)(false);
  ...
  let slot = (0, import_react16.useMemo)(() => ({ open: data.comboboxState === 0 /* Open */, disabled: data.disabled }), [data]);
  let ourProps = {
    ref: inputRef,
    id,
    role: "combobox",
...
var Options = forwardRefWithAs(function Options2(props, ref) {
  ...
  let slot = (0, import_react16.useMemo)(() => ({ open: data.comboboxState === 0 /* Open */ }), [data]);
  let ourProps = {
    "aria-labelledby": labelledby,
    role: "listbox",
    id,
...
var Option = forwardRefWithAs(function Option2(props, ref) {
  ...
  let internalOptionRef = (0, import_react16.useRef)(null);
  ...
  let enableScrollIntoView = (0, import_react16.useRef)(data.__demoMode ? false : true);
  useIsoMorphicEffect(() => {
    if (!data.__demoMode)
      return;
    let d = disposables();
  ...
  let slot = (0, import_react16.useMemo)(() => ({ active, selected, disabled }), [active, selected, disabled]);
  let ourProps = {
    id,
    ref: optionRef,
    role: "option",
...
function useTabDirection() {
  let direction = (0, import_react18.useRef)(0 /* Forwards */);
...
function useIsMounted() {
  let mounted = (0, import_react19.useRef)(false);
  useIsoMorphicEffect(() => {
...
function useOwnerDocument(...args) {
  return (0, import_react20.useMemo)(() => getOwnerDocument(...args), [...args]);
}
...
var FocusTrap = Object.assign(forwardRefWithAs(function FocusTrap2(props, ref) {
  ...
  let d = useDisposables();
  let recentlyUsedTabKey = (0, import_react22.useRef)(false);
  let ourProps = {
    ref: focusTrapRef,
    onKeyDown(e) {
      if (e.key == "Tab") {
  ...
  return /* @__PURE__ */ React5.createElement(React5.Fragment, null, Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ React5.createElement(Hidden, {
    as: "button",
    type: "button",
    ...
    name: "FocusTrap"
  }), Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ React5.createElement(Hidden, {
    as: "button",
    type: "button",
    "data-headlessui-focus-guard": true,
    onFocus: handleFocus,
...
function useRestoreFocus({ ownerDocument }, enabled) {
  let restoreElement = (0, import_react22.useRef)(null);
...
function useInitialFocus({
  ...
  let previousActiveElement = (0, import_react22.useRef)(null);
...
var ForcePortalRootContext = (0, import_react23.createContext)(false);
function usePortalRoot() {
  return (0, import_react23.useContext)(ForcePortalRootContext);
}
function ForcePortalRoot(props) {
  return /* @__PURE__ */ React6.createElement(ForcePortalRootContext.Provider, {
    value: props.force
  }, props.children);
}
...
function usePortalTarget(ref) {
  ...
  let groupTarget = (0, import_react24.useContext)(PortalGroupContext);
  let ownerDocument = useOwnerDocument(ref);
  let [target, setTarget] = (0, import_react24.useState)(() => {
...
var DEFAULT_PORTAL_TAG = import_react24.Fragment;
var PortalRoot = forwardRefWithAs(function Portal(props, ref) {
  let theirProps = props;
  let internalPortalRootRef = (0, import_react24.useRef)(null);
  ...
  let [element] = (0, import_react24.useState)(() => {
    var _a3;
...
var DEFAULT_GROUP_TAG = import_react24.Fragment;
var PortalGroupContext = (0, import_react24.createContext)(null);
var Group = forwardRefWithAs(function Group2(props, ref) {
  let { target, ...theirProps } = props;
  let groupRef = useSyncRefs(ref);
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ React7.createElement(PortalGroupContext.Provider, {
    value: target
  }, render({
    ourProps,
    theirProps,
  ...
  return [
    ...
    (0, import_react25.useMemo)(() => {
      return function DescriptionProvider(props) {
        ...
        let contextBag = (0, import_react25.useMemo)(() => ({ register, slot: props.slot, name: props.name, props: props.props }), [register, props.slot, props.name, props.props]);
        return /* @__PURE__ */ React8.createElement(DescriptionContext.Provider, {
          value: contextBag
        }, props.children);
      };
    }, [setDescriptionIds])
...
var StackContext = (0, import_react26.createContext)(() => {
});
StackContext.displayName = "StackContext";
function useStackContext() {
  return (0, import_react26.useContext)(StackContext);
}
function StackProvider({
  ...
  return /* @__PURE__ */ React9.createElement(StackContext.Provider, {
    value: notify
  }, children);
}
...
var { useState: useState9, useEffect: useEffect14, useLayoutEffect: useLayoutEffect2, useDebugValue } = React10;
...
var DialogContext = (0, import_react27.createContext)(null);
DialogContext.displayName = "DialogContext";
function useDialogContext(component) {
  let context = (0, import_react27.useContext)(DialogContext);
  if (context === null) {
...
var DialogRoot = forwardRefWithAs(function Dialog(props, ref) {
  ...
  let [nestedDialogCount, setNestedDialogCount] = (0, import_react27.useState)(0);
  let usesOpenClosedState = useOpenClosed();
  ...
  let containers = (0, import_react27.useRef)(/* @__PURE__ */ new Set());
  let internalDialogRef = (0, import_react27.useRef)(null);
  let dialogRef = useSyncRefs(internalDialogRef, ref);
  let mainTreeNode = (0, import_react27.useRef)(null);
  ...
  let [state, dispatch] = (0, import_react27.useReducer)(stateReducer2, {
    titleId: null,
    descriptionId: null,
    panelRef: (0, import_react27.createRef)()
  });
  ...
  let hasParentDialog = (0, import_react27.useContext)(DialogContext) !== null;
  ...
  let contextBag = (0, import_react27.useMemo)(() => [{ dialogState, close, setTitleId }, state], [dialogState, state, close, setTitleId]);
  let slot = (0, import_react27.useMemo)(() => ({ open: dialogState === 0 /* Open */ }), [dialogState]);
  let ourProps = {
    ref: dialogRef,
    id,
    role: "dialog",
  ...
  return /* @__PURE__ */ React12.createElement(StackProvider, {
    type: "Dialog",
  ...
  }, /* @__PURE__ */ React12.createElement(ForcePortalRoot, {
    force: true
  }, /* @__PURE__ */ React12.createElement(Portal2, null, /* @__PURE__ */ React12.createElement(DialogContext.Provider, {
    value: contextBag
  }, /* @__PURE__ */ React12.createElement(Portal2.Group, {
    target: internalDialogRef
  }, /* @__PURE__ */ React12.createElement(ForcePortalRoot, {
    force: false
  }, /* @__PURE__ */ React12.createElement(DescriptionProvider, {
    slot,
    ...
    name: "Dialog"
  })))))))), /* @__PURE__ */ React12.createElement(Hidden, {
    features: 4 /* Hidden */,
    ref: mainTreeNode
  }));
});
...
var Backdrop = forwardRefWithAs(function Backdrop2(props, ref) {
  ...
  return /* @__PURE__ */ React12.createElement(ForcePortalRoot, {
    force: true
  }, /* @__PURE__ */ React12.createElement(Portal2, null, render({
    ourProps,
    theirProps,
    slot,
...
var _a2;
var startTransition2 = (_a2 = React13.startTransition) != null ? _a2 : function startTransition3(cb) {
  cb();
};
...
var DisclosureContext = (0, import_react28.createContext)(null);
DisclosureContext.displayName = "DisclosureContext";
function useDisclosureContext(component) {
  let context = (0, import_react28.useContext)(DisclosureContext);
  if (context === null) {
...
var DisclosureAPIContext = (0, import_react28.createContext)(null);
DisclosureAPIContext.displayName = "DisclosureAPIContext";
function useDisclosureAPIContext(component) {
  let context = (0, import_react28.useContext)(DisclosureAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Disclosure /> component.`);
    if (Error.captureStackTrace)
...
var DisclosurePanelContext = (0, import_react28.createContext)(null);
DisclosurePanelContext.displayName = "DisclosurePanelContext";
function useDisclosurePanelContext() {
  return (0, import_react28.useContext)(DisclosurePanelContext);
}
function stateReducer3(state, action) {
  return match(action.type, reducers3, state, action);
}
var DEFAULT_DISCLOSURE_TAG = import_react28.Fragment;
var DisclosureRoot = forwardRefWithAs(function Disclosure(props, ref) {
  let { defaultOpen = false, ...theirProps } = props;
  let internalDisclosureRef = (0, import_react28.useRef)(null);
  let disclosureRef = useSyncRefs(ref, optionalRef((ref2) => {
    internalDisclosureRef.current = ref2;
  }, props.as === void 0 || props.as === import_react28.Fragment));
  let panelRef = (0, import_react28.useRef)(null);
  let buttonRef = (0, import_react28.useRef)(null);
  let reducerBag = (0, import_react28.useReducer)(stateReducer3, {
  ...
  let slot = (0, import_react28.useMemo)(() => ({ open: disclosureState === 0 /* Open */, close }), [disclosureState, close]);
  let ourProps = {
    ref: disclosureRef
  };
  return /* @__PURE__ */ React14.createElement(DisclosureContext.Provider, {
    value: reducerBag
  }, /* @__PURE__ */ React14.createElement(DisclosureAPIContext.Provider, {
    value: api
  }, /* @__PURE__ */ React14.createElement(OpenClosedProvider, {
...
var Button3 = forwardRefWithAs(function Button4(props, ref) {
  ...
  let slot = (0, import_react28.useMemo)(() => ({ open: state.disclosureState === 0 /* Open */ }), [state]);
...
var Panel3 = forwardRefWithAs(function Panel4(props, ref) {
  ...
  let panelRef = useSyncRefs(ref, state.panelRef, (el) => {
    startTransition2(() => dispatch({ type: el ? 4 /* LinkPanel */ : 5 /* UnlinkPanel */ }));
  });
  (0, import_react28.useEffect)(() => {
  ...
  let slot = (0, import_react28.useMemo)(() => ({ open: state.disclosureState === 0 /* Open */, close }), [state, close]);
  let ourProps = {
    ref: panelRef,
    id
  };
  return /* @__PURE__ */ React14.createElement(DisclosurePanelContext.Provider, {
    value: state.panelId
  }, render({
    ourProps,
    theirProps,
...
var ListboxActionsContext = (0, import_react29.createContext)(null);
ListboxActionsContext.displayName = "ListboxActionsContext";
function useActions2(component) {
  let context = (0, import_react29.useContext)(ListboxActionsContext);
  if (context === null) {
...
var ListboxDataContext = (0, import_react29.createContext)(null);
ListboxDataContext.displayName = "ListboxDataContext";
function useData2(component) {
  let context = (0, import_react29.useContext)(ListboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Listbox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_LISTBOX_TAG = import_react29.Fragment;
var ListboxRoot = forwardRefWithAs(function Listbox(props, ref) {
  ...
  let [value = multiple ? [] : void 0, theirOnChange] = useControllable(controlledValue, controlledOnChange, defaultValue);
  let [state, dispatch] = (0, import_react29.useReducer)(stateReducer4, {
    dataRef: (0, import_react29.createRef)(),
  ...
  let optionsPropsRef = (0, import_react29.useRef)({ static: false, hold: false });
  let labelRef = (0, import_react29.useRef)(null);
  let buttonRef = (0, import_react29.useRef)(null);
  let optionsRef = (0, import_react29.useRef)(null);
  let compare = useEvent(typeof by === "string" ? (a, z) => {
    let property = by;
    return (a == null ? void 0 : a[property]) === (z == null ? void 0 : z[property]);
  } : by);
  let isSelected = (0, import_react29.useCallback)((compareValue) => match(data.mode, {
    [1 /* Multi */]: () => value.some((option) => compare(option, compareValue)),
    [0 /* Single */]: () => compare(value, compareValue)
  }), [value]);
  let data = (0, import_react29.useMemo)(() => ({
    ...state,
    value,
    disabled,
    mode: multiple ? 1 /* Multi */ : 0 /* Single */,
  ...
  let slot = (0, import_react29.useMemo)(() => ({ open: data.listboxState === 0 /* Open */, disabled, value }), [data, disabled, value]);
  let selectOption = useEvent((id) => {
    let option = data.options.find((item) => item.id === id);
    if (!option)
      return;
  ...
  let actions = (0, import_react29.useMemo)(() => ({
    onChange,
    registerOption,
    registerLabel,
    goToOption,
  ...
  let form = (0, import_react29.useRef)(null);
  let d = useDisposables();
  ...
  return /* @__PURE__ */ React15.createElement(ListboxActionsContext.Provider, {
    value: actions
  }, /* @__PURE__ */ React15.createElement(ListboxDataContext.Provider, {
    value: data
  }, /* @__PURE__ */ React15.createElement(OpenClosedProvider, {
    value: match(data.listboxState, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })
  }, name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2], idx) => /* @__PURE__ */ React15.createElement(Hidden, {
    features: 4 /* Hidden */,
    ref: idx === 0 ? (element) => {
      var _a3;
      form.current = (_a3 = element == null ? void 0 : element.closest("form")) != null ? _a3 : null;
...
var Label3 = forwardRefWithAs(function Label4(props, ref) {
  ...
  let slot = (0, import_react29.useMemo)(() => ({ open: data.listboxState === 0 /* Open */, disabled: data.disabled }), [data]);
  let ourProps = { ref: labelRef, id, onClick: handleClick };
  return render({
    ourProps,
    theirProps,
...
var Options3 = forwardRefWithAs(function Options4(props, ref) {
  ...
  let slot = (0, import_react29.useMemo)(() => ({ open: data.listboxState === 0 /* Open */ }), [data]);
  let ourProps = {
...
var Option3 = forwardRefWithAs(function Option4(props, ref) {
  ...
  let active = data.activeOptionIndex !== null ? data.options[data.activeOptionIndex].id === id : false;
  let selected = data.isSelected(value);
  let internalOptionRef = (0, import_react29.useRef)(null);
  let bag = useLatestValue({
    disabled,
    value,
    domRef: internalOptionRef,
  ...
  let slot = (0, import_react29.useMemo)(() => ({ active, selected, disabled }), [active, selected, disabled]);
  let ourProps = {
    id,
    ref: optionRef,
    role: "option",
...
var MenuContext = (0, import_react30.createContext)(null);
MenuContext.displayName = "MenuContext";
function useMenuContext(component) {
  let context = (0, import_react30.useContext)(MenuContext);
  if (context === null) {
...
var DEFAULT_MENU_TAG = import_react30.Fragment;
var MenuRoot = forwardRefWithAs(function Menu(props, ref) {
  let reducerBag = (0, import_react30.useReducer)(stateReducer5, {
    menuState: 1 /* Closed */,
    buttonRef: (0, import_react30.createRef)(),
    itemsRef: (0, import_react30.createRef)(),
    items: [],
    searchQuery: "",
  ...
  let slot = (0, import_react30.useMemo)(() => ({ open: menuState === 0 /* Open */, close }), [menuState, close]);
  let theirProps = props;
  let ourProps = { ref: menuRef };
  return /* @__PURE__ */ React16.createElement(MenuContext.Provider, {
    value: reducerBag
  }, /* @__PURE__ */ React16.createElement(OpenClosedProvider, {
...
var Button7 = forwardRefWithAs(function Button8(props, ref) {
  ...
  let slot = (0, import_react30.useMemo)(() => ({ open: state.menuState === 0 /* Open */ }), [state]);
  let ourProps = {
    ref: buttonRef,
    id,
...
var DEFAULT_ITEM_TAG = import_react30.Fragment;
var Item = forwardRefWithAs(function Item2(props, ref) {
  ...
  let internalItemRef = (0, import_react30.useRef)(null);
  ...
  let bag = (0, import_react30.useRef)({ disabled, domRef: internalItemRef });
  useIsoMorphicEffect(() => {
  ...
  let slot = (0, import_react30.useMemo)(() => ({ active, disabled, close }), [active, disabled, close]);
  let ourProps = {
    id,
    ref: itemRef,
    role: "menuitem",
...
var PopoverContext = (0, import_react31.createContext)(null);
PopoverContext.displayName = "PopoverContext";
function usePopoverContext(component) {
  let context = (0, import_react31.useContext)(PopoverContext);
  if (context === null) {
...
var PopoverAPIContext = (0, import_react31.createContext)(null);
PopoverAPIContext.displayName = "PopoverAPIContext";
function usePopoverAPIContext(component) {
  let context = (0, import_react31.useContext)(PopoverAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Popover /> component.`);
    if (Error.captureStackTrace)
...
var PopoverGroupContext = (0, import_react31.createContext)(null);
PopoverGroupContext.displayName = "PopoverGroupContext";
function usePopoverGroupContext() {
  return (0, import_react31.useContext)(PopoverGroupContext);
}
var PopoverPanelContext = (0, import_react31.createContext)(null);
PopoverPanelContext.displayName = "PopoverPanelContext";
function usePopoverPanelContext() {
  return (0, import_react31.useContext)(PopoverPanelContext);
}
...
var PopoverRoot = forwardRefWithAs(function Popover(props, ref) {
  var _a3;
  let internalPopoverRef = (0, import_react31.useRef)(null);
  let popoverRef = useSyncRefs(ref, optionalRef((ref2) => {
    internalPopoverRef.current = ref2;
  }));
  let buttons = (0, import_react31.useRef)([]);
  let reducerBag = (0, import_react31.useReducer)(stateReducer6, {
    ...
    panel: null,
    panelId: null,
    beforePanelSentinel: (0, import_react31.createRef)(),
  ...
  let isPortalled = (0, import_react31.useMemo)(() => {
    if (!button)
      return false;
    if (!panel)
      return false;
  ...
  let registerBag = (0, import_react31.useMemo)(() => ({
  ...
  (0, import_react31.useEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag), [registerPopover, registerBag]);
  useEventListener(ownerDocument == null ? void 0 : ownerDocument.defaultView, "focus", (event) => {
    var _a4, _b, _c, _d;
  ...
  let api = (0, import_react31.useMemo)(() => ({ close, isPortalled }), [close, isPortalled]);
  let slot = (0, import_react31.useMemo)(() => ({ open: popoverState === 0 /* Open */, close }), [popoverState, close]);
  let theirProps = props;
  let ourProps = { ref: popoverRef };
  return /* @__PURE__ */ React17.createElement(PopoverContext.Provider, {
    value: reducerBag
  }, /* @__PURE__ */ React17.createElement(PopoverAPIContext.Provider, {
    value: api
  }, /* @__PURE__ */ React17.createElement(OpenClosedProvider, {
...
var Button9 = forwardRefWithAs(function Button10(props, ref) {
  ...
  let [uniqueIdentifier] = (0, import_react31.useState)(() => Symbol());
  ...
  let slot = (0, import_react31.useMemo)(() => ({ open: visible }), [visible]);
  let type = useResolveButtonType(props, internalButtonRef);
  ...
  return /* @__PURE__ */ React17.createElement(React17.Fragment, null, render({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_BUTTON_TAG5,
    name: "Popover.Button"
  }), visible && !isWithinPanel && isPortalled && /* @__PURE__ */ React17.createElement(Hidden, {
    id: sentinelId,
    features: 2 /* Focusable */,
    "data-headlessui-focus-guard": true,
    as: "button",
...
var Overlay3 = forwardRefWithAs(function Overlay4(props, ref) {
  ...
  let slot = (0, import_react31.useMemo)(() => ({ open: popoverState === 0 /* Open */ }), [popoverState]);
  let ourProps = {
    ref: overlayRef,
    id,
    "aria-hidden": true,
...
var Panel5 = forwardRefWithAs(function Panel6(props, ref) {
  ...
  let internalPanelRef = (0, import_react31.useRef)(null);
  ...
  let slot = (0, import_react31.useMemo)(() => ({ open: state.popoverState === 0 /* Open */, close }), [state, close]);
  let ourProps = {
    ref: panelRef,
    id,
    onKeyDown: handleKeyDown,
  ...
  return /* @__PURE__ */ React17.createElement(PopoverPanelContext.Provider, {
    value: id
  }, visible && isPortalled && /* @__PURE__ */ React17.createElement(Hidden, {
...
var Group3 = forwardRefWithAs(function Group4(props, ref) {
  let internalGroupRef = (0, import_react31.useRef)(null);
  let groupRef = useSyncRefs(internalGroupRef, ref);
  let [popovers, setPopovers] = (0, import_react31.useState)([]);
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ React17.createElement(PopoverGroupContext.Provider, {
    value: contextBag
  }, render({
    ourProps,
    theirProps,
...
function useFlags(initialFlags = 0) {
  let [flags, setFlags] = (0, import_react32.useState)(initialFlags);
  let addFlag = (0, import_react32.useCallback)((flag) => setFlags((flags2) => flags2 | flag), [flags]);
  let hasFlag = (0, import_react32.useCallback)((flag) => Boolean(flags & flag), [flags]);
  let removeFlag = (0, import_react32.useCallback)((flag) => setFlags((flags2) => flags2 & ~flag), [setFlags]);
  let toggleFlag = (0, import_react32.useCallback)((flag) => setFlags((flags2) => flags2 ^ flag), [setFlags]);
...
var LabelContext = (0, import_react33.createContext)(null);
function useLabelContext() {
  let context = (0, import_react33.useContext)(LabelContext);
  if (context === null) {
...
function useLabels() {
  let [labelIds, setLabelIds] = (0, import_react33.useState)([]);
  return [
    ...
    (0, import_react33.useMemo)(() => {
      return function LabelProvider(props) {
        ...
        let contextBag = (0, import_react33.useMemo)(() => ({ register, slot: props.slot, name: props.name, props: props.props }), [register, props.slot, props.name, props.props]);
        return /* @__PURE__ */ React18.createElement(LabelContext.Provider, {
          value: contextBag
        }, props.children);
      };
    }, [setLabelIds])
...
var RadioGroupDataContext = (0, import_react34.createContext)(null);
RadioGroupDataContext.displayName = "RadioGroupDataContext";
function useData3(component) {
  let context = (0, import_react34.useContext)(RadioGroupDataContext);
  if (context === null) {
...
var RadioGroupActionsContext = (0, import_react34.createContext)(null);
RadioGroupActionsContext.displayName = "RadioGroupActionsContext";
function useActions3(component) {
  let context = (0, import_react34.useContext)(RadioGroupActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <RadioGroup /> component.`);
    if (Error.captureStackTrace)
...
var RadioGroupRoot = forwardRefWithAs(function RadioGroup(props, ref) {
  ...
  let [state, dispatch] = (0, import_react34.useReducer)(stateReducer7, { options: [] });
  let options = state.options;
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let internalRadioGroupRef = (0, import_react34.useRef)(null);
  ...
  let firstOption = (0, import_react34.useMemo)(() => options.find((option) => {
    if (option.propsRef.current.disabled)
      return false;
    return true;
  }), [options]);
  let containsCheckedOption = (0, import_react34.useMemo)(() => options.some((option) => compare(option.propsRef.current.value, value)), [options, value]);
  ...
  let radioGroupData = (0, import_react34.useMemo)(() => ({ value, firstOption, containsCheckedOption, disabled, compare, ...state }), [value, firstOption, containsCheckedOption, disabled, compare, state]);
  let radioGroupActions = (0, import_react34.useMemo)(() => ({ registerOption, change: triggerChange }), [registerOption, triggerChange]);
  let ourProps = {
    ref: radioGroupRef,
    id,
    role: "radiogroup",
  ...
  let slot = (0, import_react34.useMemo)(() => ({ value }), [value]);
  ...
  return /* @__PURE__ */ React19.createElement(DescriptionProvider, {
    name: "RadioGroup.Description"
  }, /* @__PURE__ */ React19.createElement(LabelProvider, {
    name: "RadioGroup.Label"
  }, /* @__PURE__ */ React19.createElement(RadioGroupActionsContext.Provider, {
    value: radioGroupActions
  }, /* @__PURE__ */ React19.createElement(RadioGroupDataContext.Provider, {
    value: radioGroupData
  }, name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2], idx) => /* @__PURE__ */ React19.createElement(Hidden, {
    features: 4 /* Hidden */,
    ref: idx === 0 ? (element) => {
      var _a3;
      form.current = (_a3 = element == null ? void 0 : element.closest("form")) != null ? _a3 : null;
...
var Option5 = forwardRefWithAs(function Option6(props, ref) {
  ...
  let slot = (0, import_react34.useMemo)(() => ({ checked, disabled: isDisabled, active: hasFlag(2 /* Active */) }), [checked, isDisabled, hasFlag]);
  return /* @__PURE__ */ React19.createElement(DescriptionProvider, {
    name: "RadioGroup.Description"
  }, /* @__PURE__ */ React19.createElement(LabelProvider, {
    name: "RadioGroup.Label"
...
var GroupContext = (0, import_react35.createContext)(null);
GroupContext.displayName = "GroupContext";
var DEFAULT_GROUP_TAG3 = import_react35.Fragment;
function Group5(props) {
  let [switchElement, setSwitchElement] = (0, import_react35.useState)(null);
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let context = (0, import_react35.useMemo)(() => ({ switch: switchElement, setSwitch: setSwitchElement, labelledby, describedby }), [switchElement, setSwitchElement, labelledby, describedby]);
  let ourProps = {};
  let theirProps = props;
  return /* @__PURE__ */ React20.createElement(DescriptionProvider, {
    name: "Switch.Description"
  }, /* @__PURE__ */ React20.createElement(LabelProvider, {
    name: "Switch.Label",
    props: {
      onClick() {
        if (!switchElement)
  ...
  }, /* @__PURE__ */ React20.createElement(GroupContext.Provider, {
    value: context
  }, render({
    ourProps,
    theirProps,
...
var SwitchRoot = forwardRefWithAs(function Switch(props, ref) {
  ...
  let groupContext = (0, import_react35.useContext)(GroupContext);
  let internalSwitchRef = (0, import_react35.useRef)(null);
  ...
  let slot = (0, import_react35.useMemo)(() => ({ checked }), [checked]);
  let ourProps = {
    id,
    ref: switchRef,
    role: "switch",
  ...
  return /* @__PURE__ */ React20.createElement(React20.Fragment, null, name != null && checked && /* @__PURE__ */ React20.createElement(Hidden, {
    features: 4 /* Hidden */,
    ...compact({
      as: "input",
      type: "checkbox",
...
function FocusSentinel({ onFocus }) {
  let [enabled, setEnabled] = (0, import_react36.useState)(true);
  if (!enabled)
    return null;
  return /* @__PURE__ */ React21.createElement(Hidden, {
    as: "button",
    type: "button",
    features: 2 /* Focusable */,
    onFocus: (event) => {
...
var TabsDataContext = (0, import_react37.createContext)(null);
TabsDataContext.displayName = "TabsDataContext";
function useData4(component) {
  let context = (0, import_react37.useContext)(TabsDataContext);
  if (context === null) {
...
var TabsActionsContext = (0, import_react37.createContext)(null);
TabsActionsContext.displayName = "TabsActionsContext";
function useActions4(component) {
  let context = (0, import_react37.useContext)(TabsActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Tab.Group /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_TABS_TAG = import_react37.Fragment;
var Tabs = forwardRefWithAs(function Tabs2(props, ref) {
  ...
  let [state, dispatch] = (0, import_react37.useReducer)(stateReducer8, {
    selectedIndex: selectedIndex != null ? selectedIndex : defaultIndex,
    tabs: [],
    panels: []
  });
  let slot = (0, import_react37.useMemo)(() => ({ selectedIndex: state.selectedIndex }), [state.selectedIndex]);
  let onChangeRef = useLatestValue(onChange || (() => {
  }));
  let stableTabsRef = useLatestValue(state.tabs);
  let tabsData = (0, import_react37.useMemo)(() => ({ orientation, activation, ...state }), [orientation, activation, state]);
  ...
  let tabsActions = (0, import_react37.useMemo)(() => ({ registerTab, registerPanel, change }), []);
  useIsoMorphicEffect(() => {
  ...
  return /* @__PURE__ */ React23.createElement(StableCollection, null, /* @__PURE__ */ React23.createElement(TabsActionsContext.Provider, {
    value: tabsActions
  }, /* @__PURE__ */ React23.createElement(TabsDataContext.Provider, {
    value: tabsData
  }, tabsData.tabs.length <= 0 && /* @__PURE__ */ React23.createElement(FocusSentinel, {
    onFocus: () => {
      var _a3, _b;
...
var TabRoot = forwardRefWithAs(function Tab(props, ref) {
  ...
  let internalTabRef = (0, import_react37.useRef)(null);
  ...
  let ready = (0, import_react37.useRef)(false);
  ...
  let slot = (0, import_react37.useMemo)(() => ({ selected }), [selected]);
  let ourProps = {
    ref: tabRef,
    onKeyDown: handleKeyDown,
    onMouseDown: handleMouseDown,
...
var Panels = forwardRefWithAs(function Panels2(props, ref) {
  ...
  let slot = (0, import_react37.useMemo)(() => ({ selectedIndex }), [selectedIndex]);
  let theirProps = props;
...
var Panel7 = forwardRefWithAs(function Panel8(props, ref) {
  ...
  if (!selected && ((_c = theirProps.unmount) != null ? _c : true) && !((_d = theirProps.static) != null ? _d : false)) {
    return /* @__PURE__ */ React23.createElement(Hidden, {
      as: "span",
      ...ourProps
    });
  }
...
var TransitionContext = (0, import_react38.createContext)(null);
TransitionContext.displayName = "TransitionContext";
function useTransitionContext() {
  let context = (0, import_react38.useContext)(TransitionContext);
  if (context === null) {
...
function useParentNesting() {
  let context = (0, import_react38.useContext)(NestingContext);
  if (context === null) {
    throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  }
  return context;
}
var NestingContext = (0, import_react38.createContext)(null);
...
function useNesting(done, parent) {
  ...
  let transitionableChildren = (0, import_react38.useRef)([]);
  let mounted = useIsMounted();
  let d = useDisposables();
  ...
  let todos = (0, import_react38.useRef)([]);
  let wait = (0, import_react38.useRef)(Promise.resolve());
  let chains = (0, import_react38.useRef)({
    enter: [],
    leave: [],
    idle: []
  });
...
function useEvents(events) {
  let eventsRef = (0, import_react38.useRef)(ensureEventHooksExist(events));
...
var TransitionChild = forwardRefWithAs(function TransitionChild2(props, ref) {
  ...
  let container = (0, import_react38.useRef)(null);
  let transitionRef = useSyncRefs(container, ref);
  let strategy = rest.unmount ? 0 /* Unmount */ : 1 /* Hidden */;
  let { show, appear, initial } = useTransitionContext();
  let [state, setState] = (0, import_react38.useState)(show ? "visible" /* Visible */ : "hidden" /* Hidden */);
  let parentNesting = useParentNesting();
  let { register, unregister } = parentNesting;
  let prevShow = (0, import_react38.useRef)(null);
  (0, import_react38.useEffect)(() => register(container), [register, container]);
  (0, import_react38.useEffect)(() => {
  ...
  return /* @__PURE__ */ React24.createElement(NestingContext.Provider, {
    value: nesting
  }, /* @__PURE__ */ React24.createElement(OpenClosedProvider, {
    value: match(state, {
...
var TransitionRoot = forwardRefWithAs(function Transition(props, ref) {
  ...
  let internalTransitionRef = (0, import_react38.useRef)(null);
  ...
  let [initial, setInitial] = (0, import_react38.useState)(true);
  let changes = (0, import_react38.useRef)([show]);
  useIsoMorphicEffect(() => {
    if (initial === false) {
      return;
    }
  ...
  let transitionBag = (0, import_react38.useMemo)(() => ({ show, appear, initial }), [show, appear, initial]);
  (0, import_react38.useEffect)(() => {
    if (show) {
      setState("visible" /* Visible */);
  ...
  return /* @__PURE__ */ React24.createElement(NestingContext.Provider, {
    value: nestingBag
  }, /* @__PURE__ */ React24.createElement(TransitionContext.Provider, {
    value: transitionBag
  }, render({
    ourProps: {
      ...sharedProps,
      as: import_react38.Fragment,
      children: /* @__PURE__ */ React24.createElement(TransitionChild, {
        ref: transitionRef,
        ...sharedProps,
        ...theirProps
      })
    ...
    theirProps: {},
    defaultTag: import_react38.Fragment,
    features: TransitionChildRenderFeatures,
    visible: state === "visible" /* Visible */,
    name: "Transition"
  })));
...
var Child = forwardRefWithAs(function Child2(props, ref) {
  let hasTransitionContext = (0, import_react38.useContext)(TransitionContext) !== null;
  let hasOpenClosedContext = useOpenClosed() !== null;
  return /* @__PURE__ */ React24.createElement(React24.Fragment, null, !hasTransitionContext && hasOpenClosedContext ? /* @__PURE__ */ React24.createElement(TransitionRoot, {
    ref,
    ...props
  }) : /* @__PURE__ */ React24.createElement(TransitionChild, {
    ref,
    ...props
  }));
});
